        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SponsorAddres = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SponsorPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PassportUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProfileCompletionStage = table.Column<int>(type: "int", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseSubTopics_CourseTopics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifiedByAdmin = table.Column<bool>(type: "bit", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_Enrollments_EnrollmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnrollmentId = table.Column<long>(type: "bigint", nullable: true),
                    SubTopicId = table.Column<long>(type: "bigint", nullable: true),
                    TopicId = table.Column<long>(type: "bigint", nullable: true),
                    StartedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastAccessedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StartedByUser = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressRecords_CourseSubTopics_SubTopicId",
                        column: x => x.SubTopicId,
                        principalTable: "CourseSubTopics",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProgressRecords_CourseTopics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "CourseTopics",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProgressRecords_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSubTopics_TopicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressRecords_StudentProfileId",
                table: "ProgressRecords",
                column: "StudentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressRecords_SubTopicId",
                table: "ProgressRecords",
                column: "SubTopicId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressRecords_TopicId",
                table: "ProgressRecords",
                column: "TopicId");
