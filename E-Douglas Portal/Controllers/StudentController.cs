...
namespace E_Douglas_Portal.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        [HttpGet]
        public IActionResult CourseDetails(int courseId) => View();

        [HttpGet]
        public IActionResult Progress(int courseId) => View();

        [HttpGet]
        public IActionResult Certificate(int courseId) => View();
        ...
        public async Task<IActionResult> CompleteProfile()
        {
            ...
            var profile = await _context.StudentProfiles.FindAsync(user.Id);
            if (profile == null)
            {
        ...
        public async Task<IActionResult> CompleteProfile(StudentProfile model, IFormFile? passportFile)
        {
            ...
            var profile = await _context.StudentProfiles.FindAsync(model.Id);
